...
INSERT INTO Procedure(category_id, name, podolog_expert_minutes, podolog_expert_price, podolog_minutes, podolog_price,
                      enabled)
...
INSERT INTO Procedure(category_id, name, podolog_expert_minutes, podolog_expert_price, podolog_minutes, podolog_price,
                      enabled)
VALUES (1,
        'Педикюр сложный (натоптыши, трещины, мозоли до 5шт, онихофогрифоз 7-10 ногдей врастающие ногти 1-2 стадии(боль, легкое покраснение))',
        90, 2300, 120, 2000, true);
